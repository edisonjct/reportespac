...
<html lang="en">
    ...
    <body>
            ...
            <form class="form-inline" role="form" method="GET">
                <center>
                    ...
                    <div class="form-group">
                        <labe>Selecione Fecha </labe>
                        <div class="input-group date" id="datedesde">
                            <input type="text" class="form-control" id="desde" data-toggle="tooltip" title="Selecione Fecha">
                ...
                <br>
                <div align="center">
                    <div class="table-responsive" id="agrega-registros4"></div>
                </div>
        ...
        <div class="footer">
            <form class="form-inline" role="form" method="GET">
            <div align="center">                
                <button type="button" class="buttonfooter" id="procesafpagosadm"><img src="../recursos/move_f2.png" class="img-rounded" width="15" height="15"> BUSCAR</button>
