                ...
                <form class="form-inline" role="form" method="POST" id="formulario">
                    <center>
                        ...
                        <tr>
                            ...
                            <td width="30%">
                                <select required="required" id="locales" name="locales">
...
include_once '../php/conexionC.php';
    ...
    if (mysql_num_rows($query) > 0) {
        while ($row = mysql_fetch_array($query)) {
            echo "<option value='" . $row['codigocodigo'] . "'>" . $row['nombre'] . "</option>\n";
        }
    }
    ?>
                                </select>
                        ...
                        <div id="detalleproductos">
                            <table width="50%" border="0" id="detalle">
                                ...
                                <tr>
                                    <td width="1%"></td>
                                    <td td width="2%">* CODIGO</td>
                                    <td td width="10%" align="center">TITULO:</td>
                                    <td td width="1%" align="right">* STOCK:</td>
                                    <td td width="1%" align="center">* CANTID.</td>
                                    <td td width="1%" align="center">* P. UNIT.</td>
                                    <td td width="1%" align="center">TOTAL</td>
                                </tr>
                            </table>
                            <table width="50%" border="0" id="detalle">
