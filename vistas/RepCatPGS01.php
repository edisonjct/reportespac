            ...
            <form class="form-inline" role="form" method="GET">
                <center>
                    ...
                    <div class="form-group">                        
                        <select required="required" id="cb-clientesgs" class="selectpicker" data-actions-box="true" data-live-search="true" data-selected-text-format="count > 3" data-toggle="tooltip" title="Clientes Grandes Superficies">
                            <?php
