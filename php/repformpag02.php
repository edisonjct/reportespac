...
WHERE tipodoc43 = '80' AND fecdoc43 BETWEEN '$desde 00:00:00' AND '$hasta 23:59:59' 
...
FROM mrbooks.movcte WHERE mrbooks.movcte.fecdoc43 BETWEEN '$desde 00:00:00' AND '$hasta 23:59:59' AND
...
FROM mrbooks.movcte WHERE fecdoc43 BETWEEN '$desde 00:00:00' AND '$hasta 23:59:59' AND 
...
WHERE p.fecha BETWEEN '$desde 00:00:00' AND '$hasta 23:59:59' AND 
f.fecfact31 BETWEEN '$desde 00:00:00' AND '$hasta 23:59:59' AND f.cvanulado31 != '9'
GROUP BY p.fpago
ORDER BY p.fpago";

$document = "SELECT 
CASE WHEN cvanulado31 = 9 THEN 'Documentos Anulados' ELSE 'Documentos Validos' END AS doc,
CASE WHEN cvanulado31 = 9 THEN count(cvanulado31) ELSE count(cvanulado31) END AS numdoc
FROM maefac 
WHERE fecfact31 BETWEEN '$desde 00:00:00' AND '$hasta 23:59:59'
